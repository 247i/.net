...
MonoObject *
xamarin_get_inative_object_dynamic (id obj, int8_t owns, MonoReflectionType * type, GCHandle *exception_gchandle = NULL);
...
MonoObject *
xamarin_get_inative_object_static (id obj, int8_t owns, unsigned int iface_token_ref, unsigned int implementation_token_ref, GCHandle *exception_gchandle = NULL);
...
xamarin_on_marshal_objectivec_exception (id exception, int8_t throwManagedAsDefault, GCHandle *exception_gchandle = NULL);
...
void *
xamarin_lookup_unmanaged_function (const char * assembly, const char * symbol, int32_t id, GCHandle *exception_gchandle = NULL);
