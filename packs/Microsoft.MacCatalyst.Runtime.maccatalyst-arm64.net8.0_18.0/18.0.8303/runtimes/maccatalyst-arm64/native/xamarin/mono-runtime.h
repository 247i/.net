...
#define mono_unhandled_exception mono_unhandled_exception_impl
...
#define mono_get_exception_out_of_memory mono_get_exception_out_of_memory_impl
...
#define mono_debugger_agent_parse_options mono_debugger_agent_parse_options_impl
#define mono_debugger_agent_transport_handshake mono_debugger_agent_transport_handshake_impl
#define mono_debugger_agent_register_transport mono_debugger_agent_register_transport_impl
#if DOTNET
#define monovm_initialize monovm_initialize_impl
#endif
#if DOTNET
#define monovm_runtimeconfig_initialize monovm_runtimeconfig_initialize_impl
#endif
#endif
